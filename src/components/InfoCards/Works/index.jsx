    ...
    render() {
        return (
            <div id="worksContainer">
                ...
                <ClickAwayListener onClickAway={this.handleClickAway('visibleWork2')}>
                    <div className="list">
                        <i className="circle icon"></i>
                        <span onClick={this.handleCollapse('visibleWork2')} style={{ fontSize: '22px' }}>
                ...
                <ClickAwayListener onClickAway={this.handleClickAway('visibleWork3')}>
                    <div className="list">
                        <i className="circle icon"></i>
                        <span onClick={this.handleCollapse('visibleWork3')} style={{ fontSize: '22px' }}>
